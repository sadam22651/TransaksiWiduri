...
<body>
  ...
  <div>
    ...
    <form method="GET" action="pencaharian.php">
      ...
      <input type="date" name="tanggal_mulai"
        value="<?php if (isset($_GET['tanggal_mulai']))
          echo $_GET['tanggal_mulai']; ?>">

      <label for="">Tanggal Selesai:</label>
      <input type="date" name="tanggal_selesai"
        value="<?php if (isset($_GET['tanggal_selesai']))
          echo $_GET['tanggal_selesai']; ?>">
      ...
      <tbody>
        <?php while ($data = mysqli_fetch_array($hasil)):
          ...
          <tr>
            ...
            <td>
              <a href="update_pencaharian.php?id_transaksi=<?php echo htmlspecialchars($data['id_transaksi']); ?>"
